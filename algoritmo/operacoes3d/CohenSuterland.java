...
public class CohenSuterland extends JFrame{
	...
	public CohenSuterland() {
		...
		//		list.addAll(retangulo.retangulo(x1, y1, x2, y2));
				...
				recorte.CohenSutherlandLineClip(PanelPrincipal.getLista().get(0).getX(), PanelPrincipal.getLista().get(0).getY(), 
						PanelPrincipal.getLista().get(PanelPrincipal.getLista().size()-1).getX(), PanelPrincipal.getLista().get(PanelPrincipal.getLista().size()-1).getY(), x_min, x_max, y_min, y_max);
